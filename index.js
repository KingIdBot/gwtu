...
const BotName = 'MR BOT'; // GANTI PAKE NAMA BOT LU
const wa = 'TIDAK TERSEDIA'; // JANGAN DI GANTI
const ow = 'MR KING'; // GANTI PAKE NAMA MU
const nomorowner = '18313535216'; // GANTI PAKE NOMOR MU ( JANGAN NOMOR BOT )
const ovo = 'TIDAK TERSEDIA'; // GANTI PAKE NOMOR OVO LU
const pulsa = 'TIDAK TERSEDIA'; // GANTI PAKE NOMOR PULSA LU
const dana = 'TIDAK TERSEDIA'; // GANTI PAKE NOMOR DANA LU
const gopay = 'TIDAK TERSEDIA'; // GANTI PAKE NOMOR GOPAY LU
const instagram = 'TIDAK TERSEDIA_'; // GANTI IG LU
